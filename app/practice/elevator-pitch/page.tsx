...
export default function ElevatorPitchPracticePage() {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold mb-2">Elevator Pitch Practice</h1>
              <p className="text-muted-foreground">
                Master the art of introducing yourself in 60 seconds
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <VideoRecorder onUploadComplete={handleUploadComplete} maxDuration={60} />
              ...
              <CardContent className="space-y-3">
                ...
                <div className="p-4 bg-muted rounded-md">
                  ...
                  <ul className="text-sm space-y-1 list-disc list-inside text-muted-foreground">
                    <li>Keep it concise (60 seconds or less)</li>
